...
/******/ 			var chunk = require("./" + ({"1":"components/logo","2":"components/vuetify-logo","3":"pages/index","4":"pages/inspire","5":"pages/login"}[chunkId]||chunkId) + ".js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return kebabCase; });
...
var es_symbol_description_js_ = __webpack_require__(27);
...
"use strict";
/* harmony import */ var _src_components_VSheet_VSheet_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(55);
...
/* harmony import */ var _mixins_binds_attrs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
/* harmony import */ var _mixins_colorable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _mixins_elevatable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22);
/* harmony import */ var _mixins_measurable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
/* harmony import */ var _mixins_roundable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23);
...
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_directives_ripple_VRipple_sass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(60);
/* harmony import */ var _src_directives_ripple_VRipple_sass__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_src_directives_ripple_VRipple_sass__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _util_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
...
function keyboardRippleShow(e) {
  if (!keyboardRipple && (e.keyCode === _util_helpers__WEBPACK_IMPORTED_MODULE_2__[/* keyCodes */ "o"].enter || e.keyCode === _util_helpers__WEBPACK_IMPORTED_MODULE_2__[/* keyCodes */ "o"].space)) {
    keyboardRipple = true;
    rippleShow(e);
  }
}
...
"use strict";
/* harmony import */ var _VIcon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28);
...
/* harmony import */ var _registrable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
// Mixins
...
"use strict";
/* harmony import */ var _src_components_VIcon_VIcon_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(62);
...
"use strict";
/* harmony import */ var _VSheet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
...
var VProgressCircular = __webpack_require__(61);
...
// EXTERNAL MODULE: ./node_modules/vuetify/lib/util/console.js + 23 modules
...
const _1c111cfe = () => interopDefault(__webpack_require__.e(/* import() | pages/inspire */ 4).then(__webpack_require__.bind(null, 119)));

const _63bf0650 = () => interopDefault(__webpack_require__.e(/* import() | pages/login */ 5).then(__webpack_require__.bind(null, 117)));

const _cbd1398e = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 3).then(__webpack_require__.bind(null, 118)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=c603010e&
var defaultvue_type_template_id_c603010e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"dark":""}},[_c('v-navigation-drawer',{attrs:{"mini-variant":_vm.miniVariant,"clipped":_vm.clipped,"fixed":"","app":""},model:{value:(_vm.drawer),callback:function ($$v) {_vm.drawer=$$v},expression:"drawer"}},[_c('v-list',_vm._l((_vm.items),function(item,i){return _c('v-list-item',{key:i,attrs:{"to":item.to,"router":"","exact":""}},[_c('v-list-item-action',[_c('v-icon',[_vm._v(_vm._s(item.icon))])],1),_vm._v(" "),_c('v-list-item-content',[_c('v-list-item-title',{domProps:{"textContent":_vm._s(item.title)}})],1)],1)}),1)],1),_vm._v(" "),_c('v-app-bar',{attrs:{"clipped-left":_vm.clipped,"fixed":"","app":""}},[_c('v-app-bar-nav-icon',{on:{"click":function($event){$event.stopPropagation();_vm.drawer = !_vm.drawer}}}),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.miniVariant = !_vm.miniVariant}}},[_c('v-icon',[_vm._v("mdi-"+_vm._s(("chevron-" + (_vm.miniVariant ? "right" : "left"))))])],1),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.clipped = !_vm.clipped}}},[_c('v-icon',[_vm._v("mdi-application")])],1),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.fixed = !_vm.fixed}}},[_c('v-icon',[_vm._v("mdi-minus")])],1),_vm._v(" "),_c('v-toolbar-title',{domProps:{"textContent":_vm._s(_vm.title)}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.rightDrawer = !_vm.rightDrawer}}},[_c('v-icon',[_vm._v("mdi-menu")])],1)],1),_vm._v(" "),_c('v-main',[_c('v-container',[_c('nuxt')],1)],1),_vm._v(" "),_c('v-navigation-drawer',{attrs:{"right":_vm.right,"temporary":"","fixed":""},model:{value:(_vm.rightDrawer),callback:function ($$v) {_vm.rightDrawer=$$v},expression:"rightDrawer"}},[_c('v-list',[_c('v-list-item',{nativeOn:{"click":function($event){_vm.right = !_vm.right}}},[_c('v-list-item-action',[_c('v-icon',{attrs:{"light":""}},[_vm._v(" mdi-repeat ")])],1),_vm._v(" "),_c('v-list-item-title',[_vm._v("Switch drawer (click me)")])],1)],1)],1),_vm._v(" "),_c('v-footer',{attrs:{"absolute":!_vm.fixed,"app":""}},[_c('span',[_vm._v("© "+_vm._s(new Date().getFullYear()))])])],1)}
var defaultvue_type_template_id_c603010e_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=c603010e&
...
var es_array_flat_js_ = __webpack_require__(31);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VToolbar/VToolbar.sass
var VToolbar = __webpack_require__(54);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VSheet/VSheet.js
var VSheet = __webpack_require__(7);
...
var measurable = __webpack_require__(16);
...
var VFooter = __webpack_require__(63);
...
var VIcon_VIcon = __webpack_require__(28);
...
var VListItem = __webpack_require__(65);
...
var binds_attrs = __webpack_require__(14);
...
var VItemGroup = __webpack_require__(69);
...
var roundable = __webpack_require__(23);
...
var VMain = __webpack_require__(70);
...
var VNavigationDrawer = __webpack_require__(71);
...
var VSpacer = __webpack_require__(98);
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_c603010e_render,
  defaultvue_type_template_id_c603010e_staticRenderFns,
  false,
  null,
  null,
  "6e5bd15c"
...
installComponents_default()(default_component, {VApp: VApp_VApp,VAppBar: VAppBar_VAppBar,VAppBarNavIcon: VAppBarNavIcon,VBtn: VBtn["a" /* default */],VContainer: VContainer,VFooter: VFooter_VFooter,VIcon: VIcon_VIcon["a" /* default */],VList: VList_VList,VListItem: VList_VListItem,VListItemAction: VListItemAction,VListItemContent: VListItemContent,VListItemTitle: VListItemTitle,VMain: VMain_VMain,VNavigationDrawer: VNavigationDrawer_VNavigationDrawer,VSpacer: VSpacer["a" /* default */],VToolbarTitle: VToolbarTitle})
...
const plugin_components = {
  Logo: () => __webpack_require__.e(/* import() | components/logo */ 1).then(__webpack_require__.bind(null, 105)).then(c => wrapFunctional(c.default || c)),
  VuetifyLogo: () => __webpack_require__.e(/* import() | components/vuetify-logo */ 2).then(__webpack_require__.bind(null, 104)).then(c => wrapFunctional(c.default || c))
};
...
!external_firebase_default.a.apps.length ? external_firebase_default.a.initializeApp(firebase_config) : '';
const auth = external_firebase_default.a.auth();
const github = new external_firebase_default.a.auth.GithubAuthProvider();
...
/* Plugins */
 ...
 // Source: ../../src/plugins/firebase.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof firebase === 'function') {
    await firebase(app.context, inject);
